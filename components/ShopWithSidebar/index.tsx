...
interface ShopWithSidebarProps {
  ...
  categories: { id: string; name: string; products: number; isRefined: boolean }[];
  pagination: { page: number; total: number; totalPages: number; limit: number };
}

const ShopWithSidebar = ({ initialProducts, categories, pagination }: ShopWithSidebarProps) => {
              ...
              <form onSubmit={(e) => e.preventDefault()}>
                <div className="flex flex-col gap-6">
                  ...
                  <CategoryDropdown 
                    ...
                    onCategoryChange={(id) => updateQueryParams('category', id)}
                  />
              ...
              <div className="rounded-lg bg-white shadow-1 pl-3 pr-2.5 py-2.5 mb-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <p>
                      Showing <span className="text-dark">{initialProducts.length > 0 ? showingStart : 0} - {showingEnd} of {pagination.total}</span>{" "}
                      Products
                    </p>
                  </div>
                    ...
                    <ul className="flex items-center">
                      <li>
                        <button
                          ...
                          type="button"
                          className="flex items-center justify-center w-8 h-9 ease-out duration-200 rounded-[3px] hover:bg-gray-1 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          <svg
                            className="fill-current"
                            width="18"
